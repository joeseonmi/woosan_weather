...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire-iOS11.1/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyJSON-iOS11.1/SwiftyJSON.framework"
fi
